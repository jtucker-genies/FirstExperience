...
declare module 'UnityEngine' {
    ...
    */
    class Event extends System.Object {
        ...
        */
        public get button(): int;
        public set button(value: int);
        /**
        ...
        */
        public get penStatus(): PenStatus;
        public set penStatus(value: PenStatus);
        /**
        ...
        */
        ...
        public constructor ()
        public constructor ($displayIndex: int)
        ...
        */
        public GetTypeForControl ($controlID: int) : EventType
        /**
        ...
        */
        public static GetEventCount () : int
        /**
    ...
    */
    class GUI extends System.Object {
        ...
        */
        public static get depth(): int;
        public static set depth(value: int);
        /**
        ...
        */
        public static BringWindowToFront ($windowID: int) : void
        /**
        * Bring a specific window to back of the floating windows.
        * @param windowID The identifier used when you created the window in the Window call.
        */
        public static BringWindowToBack ($windowID: int) : void
        /**
        * Make a window become the active window.
        * @param windowID The identifier used when you created the window in the Window call.
        */
        public static FocusWindow ($windowID: int) : void
        /**
        ...
        * @param alphaBlend Whether to apply alpha blending when drawing the image (enabled by default).
        * @param imageAspect Aspect ratio to use for the source image. If 0 (the default), the aspect ratio from the image is used.  Pass in w/h for the desired aspect ratio.  This allows the aspect ratio of the source image to be adjusted without changing the pixel width and height.
        * @methodSwap DrawTexture_EBB7509C_H719A26E
        */
        public static DrawTexture ($position: Rect, $image: Texture, $scaleMode: ScaleMode, $alphaBlend: boolean, $imageAspect: float) : void
        /**
        ...
        * @methodSwap DrawTexture_EBB7509C_CBAEEA
        */
        public static DrawTexture ($position: Rect, $image: Texture, $scaleMode: ScaleMode, $alphaBlend: boolean, $imageAspect: float, $color: Color, $borderWidth: float, $borderRadius: float) : void
        /**
        * Draws a border with rounded corners within a rectangle. The texture is used to pattern the border.  Note that this method only works on shader model 2.5 and above.
        * @param position Rectangle on the screen to draw the texture within.
        * @param image Texture to display.
        ...
        * @param borderRadius The radius for rounded corners. If 0, corners will not be rounded.
        * @param borderRadiuses The radiuses for rounded corners (top-left, top-right, bottom-right and bottom-left). If Vector4.zero, corners will not be rounded.
        * @methodSwap DrawTexture_EBB7509C_F38ABC49
        */
        public static DrawTexture ($position: Rect, $image: Texture, $scaleMode: ScaleMode, $alphaBlend: boolean, $imageAspect: float, $color: Color, $borderWidths: Vector4, $borderRadius: float) : void
        /**
        * @methodSwap DrawTexture_EBB7509C_H6509A590
        */
        public static DrawTexture ($position: Rect, $image: Texture, $scaleMode: ScaleMode, $alphaBlend: boolean, $imageAspect: float, $color: Color, $borderWidths: Vector4, $borderRadiuses: Vector4) : void
        /**
        ...
        * @param style The style to use. If left out, the textField style from the current GUISkin is used.
        * @returns The edited string.
        * @methodSwap TextField_EBB7509C_H2B8F116F
        */
        public static TextField ($position: Rect, $text: string, $maxLength: int) : string
        /**
        * Make a single-line text field where the user can edit a string.
        * @param position Rectangle on the screen to use for the text field.
        * @param text Text to edit. The return value of this function should be assigned back to the string as shown in the example.
        ...
        * @param style The style to use. If left out, the textField style from the current GUISkin is used.
        * @returns The edited string.
        * @methodSwap TextField_EBB7509C_FE88D4F0
        */
        public static TextField ($position: Rect, $text: string, $maxLength: int, $style: GUIStyle) : string
        /**
        ...
        * @param style The style to use. If left out, the textField style from the current GUISkin is used.
        * @returns The edited password.
        * @methodSwap PasswordField_EBB7509C_H4DA26E8E
        */
        public static PasswordField ($position: Rect, $password: string, $maskChar: number, $maxLength: int) : string
        /**
        * Make a text field where the user can enter a password.
        * @param position Rectangle on the screen to use for the text field.
        * @param password Password to edit. The return value of this function should be assigned back to the string as shown in the example.
        ...
        * @param style The style to use. If left out, the textField style from the current GUISkin is used.
        * @returns The edited password.
        * @methodSwap PasswordField_EBB7509C_H470D7165
        */
        public static PasswordField ($position: Rect, $password: string, $maskChar: number, $maxLength: int, $style: GUIStyle) : string
        /**
        ...
        * @param style The style to use. If left out, the textArea style from the current GUISkin is used.
        * @returns The edited string.
        * @methodSwap TextArea_EBB7509C_H2B8F116F
        */
        public static TextArea ($position: Rect, $text: string, $maxLength: int) : string
        /**
        * Make a Multi-line text area where the user can edit a string.
        * @param position Rectangle on the screen to use for the text field.
        * @param text Text to edit. The return value of this function should be assigned back to the string as shown in the example.
        ...
        * @param style The style to use. If left out, the textArea style from the current GUISkin is used.
        * @returns The edited string.
        * @methodSwap TextArea_EBB7509C_FE88D4F0
        */
        public static TextArea ($position: Rect, $text: string, $maxLength: int, $style: GUIStyle) : string
        /**
        ...
        */
        ...
        /**
        * @methodSwap Toggle_EBB7509C_H13E1138C
        */
        public static Toggle ($position: Rect, $id: int, $value: boolean, $content: GUIContent, $style: GUIStyle) : boolean
        /**
        * Make a toolbar.
        ...
        * @methodSwap Toolbar_EBB7509C_H618D6241
        */
        public static Toolbar ($position: Rect, $selected: int, $texts: string[]) : int
        /**
        * Make a toolbar.
        * @param position Rectangle on the screen to use for the toolbar.
        * @param selected The index of the selected button.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_H24D445FF
        */
        public static Toolbar ($position: Rect, $selected: int, $images: Texture[]) : int
        /**
        * Make a toolbar.
        * @param position Rectangle on the screen to use for the toolbar.
        * @param selected The index of the selected button.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_C8CE53E0
        */
        public static Toolbar ($position: Rect, $selected: int, $contents: GUIContent[]) : int
        /**
        * Make a toolbar.
        * @param position Rectangle on the screen to use for the toolbar.
        * @param selected The index of the selected button.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_H3CC6596E
        */
        public static Toolbar ($position: Rect, $selected: int, $texts: string[], $style: GUIStyle) : int
        /**
        * Make a toolbar.
        * @param position Rectangle on the screen to use for the toolbar.
        * @param selected The index of the selected button.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_H15BA2060
        */
        public static Toolbar ($position: Rect, $selected: int, $images: Texture[], $style: GUIStyle) : int
        /**
        * Make a toolbar.
        * @param position Rectangle on the screen to use for the toolbar.
        * @param selected The index of the selected button.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_F1127C6B
        */
        public static Toolbar ($position: Rect, $selected: int, $contents: GUIContent[], $style: GUIStyle) : int
        /**
        * Make a toolbar.
        * @param position Rectangle on the screen to use for the toolbar.
        * @param selected The index of the selected button.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_C2DE136A
        */
        public static Toolbar ($position: Rect, $selected: int, $contents: GUIContent[], $style: GUIStyle, $buttonSize: UnityEngine_GUI.ToolbarButtonSize) : int
        /**
        ...
        * @param style The style to use. If left out, the button style from the current GUISkin is used.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H8566CC2A
        */
        public static SelectionGrid ($position: Rect, $selected: int, $texts: string[], $xCount: int) : int
        /**
        * Make a grid of buttons.
        * @param position Rectangle on the screen to use for the grid.
        * @param selected The index of the selected grid button.
        ...
        * @param style The style to use. If left out, the button style from the current GUISkin is used.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H2C3B6378
        */
        public static SelectionGrid ($position: Rect, $selected: int, $images: Texture[], $xCount: int) : int
        /**
        * Make a grid of buttons.
        * @param position Rectangle on the screen to use for the grid.
        * @param selected The index of the selected grid button.
        ...
        * @param style The style to use. If left out, the button style from the current GUISkin is used.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H95951153
        */
        public static SelectionGrid ($position: Rect, $selected: int, $content: GUIContent[], $xCount: int) : int
        /**
        * Make a grid of buttons.
        * @param position Rectangle on the screen to use for the grid.
        * @param selected The index of the selected grid button.
        ...
        * @param style The style to use. If left out, the button style from the current GUISkin is used.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H702B6B59
        */
        public static SelectionGrid ($position: Rect, $selected: int, $texts: string[], $xCount: int, $style: GUIStyle) : int
        /**
        * Make a grid of buttons.
        * @param position Rectangle on the screen to use for the grid.
        * @param selected The index of the selected grid button.
        ...
        * @param style The style to use. If left out, the button style from the current GUISkin is used.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_BA6CBA33
        */
        public static SelectionGrid ($position: Rect, $selected: int, $images: Texture[], $xCount: int, $style: GUIStyle) : int
        /**
        * Make a grid of buttons.
        * @param position Rectangle on the screen to use for the grid.
        * @param selected The index of the selected grid button.
        ...
        * @param style The style to use. If left out, the button style from the current GUISkin is used.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H450E15BC
        */
        public static SelectionGrid ($position: Rect, $selected: int, $contents: GUIContent[], $xCount: int, $style: GUIStyle) : int
        /**
        ...
        * @methodSwap HorizontalSlider_EBB7509C_H8D6195A3
        */
        public static HorizontalSlider ($position: Rect, $value: float, $leftValue: float, $rightValue: float) : float
        /**
        * A horizontal slider the user can drag to change a value between a min and a max.
        * @param position Rectangle on the screen to use for the slider.
        * @param value The value the slider shows. This determines the position of the draggable thumb.
        ...
        * @param thumb The GUIStyle to use for displaying draggable thumb. If left out, the horizontalSliderThumb style from the current GUISkin is used.
        * @returns The value that has been set by the user.
        * @methodSwap HorizontalSlider_EBB7509C_H8158E9FF
        */
        public static HorizontalSlider ($position: Rect, $value: float, $leftValue: float, $rightValue: float, $slider: GUIStyle, $thumb: GUIStyle) : float
        /**
        * @methodSwap HorizontalSlider_EBB7509C_H7DE2A460
        */
        public static HorizontalSlider ($position: Rect, $value: float, $leftValue: float, $rightValue: float, $slider: GUIStyle, $thumb: GUIStyle, $thumbExtent: GUIStyle) : float
        /**
        ...
        * @param thumb The GUIStyle to use for displaying draggable thumb. If left out, the horizontalSliderThumb style from the current GUISkin is used.
        * @returns The value that has been set by the user.
        * @methodSwap VerticalSlider_EBB7509C_H8D6195A3
        */
        public static VerticalSlider ($position: Rect, $value: float, $topValue: float, $bottomValue: float) : float
        /**
        * A vertical slider the user can drag to change a value between a min and a max.
        * @param position Rectangle on the screen to use for the slider.
        * @param value The value the slider shows. This determines the position of the draggable thumb.
        ...
        * @param thumb The GUIStyle to use for displaying draggable thumb. If left out, the horizontalSliderThumb style from the current GUISkin is used.
        * @returns The value that has been set by the user.
        * @methodSwap VerticalSlider_EBB7509C_H8158E9FF
        */
        public static VerticalSlider ($position: Rect, $value: float, $topValue: float, $bottomValue: float, $slider: GUIStyle, $thumb: GUIStyle) : float
        /**
        * @methodSwap VerticalSlider_EBB7509C_H7DE2A460
        */
        public static VerticalSlider ($position: Rect, $value: float, $topValue: float, $bottomValue: float, $slider: GUIStyle, $thumb: GUIStyle, $thumbExtent: GUIStyle) : float
        public static Slider ($position: Rect, $value: float, $size: float, $start: float, $end: float, $slider: GUIStyle, $thumb: GUIStyle, $horiz: boolean, $id: int, $thumbExtent?: GUIStyle) : float
        /**
        ...
        * @methodSwap HorizontalScrollbar_EBB7509C_H112DF74
        */
        public static HorizontalScrollbar ($position: Rect, $value: float, $size: float, $leftValue: float, $rightValue: float) : float
        /**
        * Make a horizontal scrollbar. Scrollbars are what you use to scroll through a document. Most likely, you want to use scrollViews instead.
        * @param position Rectangle on the screen to use for the scrollbar.
        * @param value The position between min and max.
        ...
        * @param style The style to use for the scrollbar background. If left out, the horizontalScrollbar style from the current GUISkin is used.
        * @returns The modified value. This can be changed by the user by dragging the scrollbar, or clicking the arrows at the end.
        * @methodSwap HorizontalScrollbar_EBB7509C_H2B490D77
        */
        public static HorizontalScrollbar ($position: Rect, $value: float, $size: float, $leftValue: float, $rightValue: float, $style: GUIStyle) : float
        /**
        ...
        * @param style The style to use for the scrollbar background. If left out, the horizontalScrollbar style from the current GUISkin is used.
        * @returns The modified value. This can be changed by the user by dragging the scrollbar, or clicking the arrows at the end.
        * @methodSwap VerticalScrollbar_EBB7509C_H112DF74
        */
        public static VerticalScrollbar ($position: Rect, $value: float, $size: float, $topValue: float, $bottomValue: float) : float
        /**
        * Make a vertical scrollbar. Scrollbars are what you use to scroll through a document. Most likely, you want to use scrollViews instead.
        * @param position Rectangle on the screen to use for the scrollbar.
        * @param value The position between min and max.
        ...
        * @param style The style to use for the scrollbar background. If left out, the horizontalScrollbar style from the current GUISkin is used.
        * @returns The modified value. This can be changed by the user by dragging the scrollbar, or clicking the arrows at the end.
        * @methodSwap VerticalScrollbar_EBB7509C_H2B490D77
        */
        public static VerticalScrollbar ($position: Rect, $value: float, $size: float, $topValue: float, $bottomValue: float, $style: GUIStyle) : float
        ...
        */
        ...
        public static ScrollTowards ($position: Rect, $maxDelta: float) : boolean
        /**
        * Make a popup window.
        ...
        * @methodSwap Window_EBB7509C_H1CC56438
        */
        public static Window ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $text: string) : Rect
        /**
        * Make a popup window.
        * @param Style An optional style to use for the window. If left out, the window style from the current GUISkin is used.
        * @param id ID number for the window (can be any value as long as it is unique).
        ...
        * @param title Text displayed in the window's title bar.
        * @returns Onscreen rectangle denoting the window's position and size.
        * @methodSwap Window_EBB7509C_B4DC76F6
        */
        public static Window ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $image: Texture) : Rect
        /**
        * Make a popup window.
        * @param Style An optional style to use for the window. If left out, the window style from the current GUISkin is used.
        * @param id ID number for the window (can be any value as long as it is unique).
        ...
        * @param title Text displayed in the window's title bar.
        * @returns Onscreen rectangle denoting the window's position and size.
        * @methodSwap Window_EBB7509C_H5EE4CBFB
        */
        public static Window ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $content: GUIContent) : Rect
        /**
        * Make a popup window.
        * @param Style An optional style to use for the window. If left out, the window style from the current GUISkin is used.
        * @param id ID number for the window (can be any value as long as it is unique).
        ...
        * @param title Text displayed in the window's title bar.
        * @returns Onscreen rectangle denoting the window's position and size.
        * @methodSwap Window_EBB7509C_H583E4C73
        */
        public static Window ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $text: string, $style: GUIStyle) : Rect
        /**
        * Make a popup window.
        * @param Style An optional style to use for the window. If left out, the window style from the current GUISkin is used.
        * @param id ID number for the window (can be any value as long as it is unique).
        ...
        * @param title Text displayed in the window's title bar.
        * @returns Onscreen rectangle denoting the window's position and size.
        * @methodSwap Window_EBB7509C_H71AF61D
        */
        public static Window ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $image: Texture, $style: GUIStyle) : Rect
        /**
        * Make a popup window.
        * @param Style An optional style to use for the window. If left out, the window style from the current GUISkin is used.
        * @param id ID number for the window (can be any value as long as it is unique).
        ...
        * @param title Text displayed in the window's title bar.
        * @returns Onscreen rectangle denoting the window's position and size.
        * @methodSwap Window_EBB7509C_F9B667D4
        */
        public static Window ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $title: GUIContent, $style: GUIStyle) : Rect
        /**
        * Show a Modal Window.
        ...
        * @methodSwap ModalWindow_EBB7509C_H1CC56438
        */
        public static ModalWindow ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $text: string) : Rect
        /**
        * Show a Modal Window.
        * @param id A unique id number.
        * @param clientRect Position and size of the window.
        ...
        * @param content GUIContent to appear in the title bar of the window, if any.
        * @param style Style to apply to the window.
        * @methodSwap ModalWindow_EBB7509C_B4DC76F6
        */
        public static ModalWindow ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $image: Texture) : Rect
        /**
        * Show a Modal Window.
        * @param id A unique id number.
        * @param clientRect Position and size of the window.
        ...
        * @param content GUIContent to appear in the title bar of the window, if any.
        * @param style Style to apply to the window.
        * @methodSwap ModalWindow_EBB7509C_H5EE4CBFB
        */
        public static ModalWindow ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $content: GUIContent) : Rect
        /**
        * Show a Modal Window.
        * @param id A unique id number.
        * @param clientRect Position and size of the window.
        ...
        * @param content GUIContent to appear in the title bar of the window, if any.
        * @param style Style to apply to the window.
        * @methodSwap ModalWindow_EBB7509C_H583E4C73
        */
        public static ModalWindow ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $text: string, $style: GUIStyle) : Rect
        /**
        * Show a Modal Window.
        * @param id A unique id number.
        * @param clientRect Position and size of the window.
        ...
        * @param content GUIContent to appear in the title bar of the window, if any.
        * @param style Style to apply to the window.
        * @methodSwap ModalWindow_EBB7509C_H71AF61D
        */
        public static ModalWindow ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $image: Texture, $style: GUIStyle) : Rect
        /**
        * Show a Modal Window.
        * @param id A unique id number.
        * @param clientRect Position and size of the window.
        ...
        * @param content GUIContent to appear in the title bar of the window, if any.
        * @param style Style to apply to the window.
        * @methodSwap ModalWindow_EBB7509C_F9B667D4
        */
        public static ModalWindow ($id: int, $clientRect: Rect, $func: UnityEngine_GUI.WindowFunction, $content: GUIContent, $style: GUIStyle) : Rect
        /**
    ...
    */
    class GUIStyle extends System.Object {
        ...
        */
        public get fixedWidth(): float;
        public set fixedWidth(value: float);
        /**
        * If non-0, any GUI elements rendered with this style will have the height specified here.
        */
        public get fixedHeight(): float;
        public set fixedHeight(value: float);
        /**
        ...
        */
        ...
        /**
        * Draw the GUIStyle with text and an image inside. If the image is too large to fit within the content area of the style it is scaled down.
        * @methodSwap Draw_EBB7509C_H1D16FF8
        */
        public Draw ($position: Rect, $content: GUIContent, $controlID: int) : void
        /**
        * Draw the GUIStyle with text and an image inside. If the image is too large to fit within the content area of the style it is scaled down.
        * @methodSwap Draw_EBB7509C_H21810DC3
        */
        public Draw ($position: Rect, $content: GUIContent, $controlID: int, $on: boolean) : void
        /**
        * @methodSwap Draw_EBB7509C_D30EB0A4
        */
        public Draw ($position: Rect, $content: GUIContent, $controlID: int, $on: boolean, $hover: boolean) : void
        /**
        * Draw this GUIStyle with selected content.
        */
        public DrawCursor ($position: Rect, $content: GUIContent, $controlID: int, $character: int) : void
        /**
        * Draw this GUIStyle with selected content.
        */
        public DrawWithTextSelection ($position: Rect, $content: GUIContent, $controlID: int, $firstSelectedCharacter: int, $lastSelectedCharacter: int) : void
        /**
        * Get the pixel position of a given string index.
        */
        public GetCursorPixelPosition ($position: Rect, $content: GUIContent, $cursorStringIndex: int) : Vector2
        /**
        * Get the cursor position (indexing into contents.text) when the user clicked at cursorPixelPosition.
        */
        public GetCursorStringIndex ($position: Rect, $content: GUIContent, $cursorPixelPosition: Vector2) : int
        /**
        ...
        */
        public CalcHeight ($content: GUIContent, $width: float) : float
        /**
        * Calculate the minimum and maximum widths for this style rendered with content.
        */
        public CalcMinMaxWidth ($content: GUIContent, $minWidth: $Ref<float>, $maxWidth: $Ref<float>) : void
        public ToString () : string
    ...
    */
    class GUISettings extends System.Object {
        ...
        */
        public get cursorFlashSpeed(): float;
        public set cursorFlashSpeed(value: float);
        /**
    ...
    */
    class GUILayout extends System.Object {
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The edited string.
        * @methodSwap TextField_EBB7509C_H1811042B
        */
        public static TextField ($text: string, $maxLength: int, ...options: GUILayoutOption[]) : string
        /**
        * Make a single-line text field where the user can edit a string.
        * @param text Text to edit. The return value of this function should be assigned back to the string as shown in the example.
        * @param maxLength The maximum length of the string. If left out, the user can type for ever and ever.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The edited string.
        * @methodSwap TextField_EBB7509C_H5B1335D4
        */
        public static TextField ($text: string, $maxLength: int, $style: GUIStyle, ...options: GUILayoutOption[]) : string
        /**
        * Make a text field where the user can enter a password.
        * @param password Password to edit. The return value of this function should be assigned back to the string as shown in the example.
        * @param maskChar Character to mask the password with.
        ...
        * @param style The style to use. If left out, the textField style from the current GUISkin is used.
        * @returns The edited password.
        * @methodSwap PasswordField_EBB7509C_H2C459A04
        */
        public static PasswordField ($password: string, $maskChar: number, $maxLength: int, ...options: GUILayoutOption[]) : string
        /**
        * Make a text field where the user can enter a password.
        * @param password Password to edit. The return value of this function should be assigned back to the string as shown in the example.
        * @param maskChar Character to mask the password with.
        ...
        * @param style The style to use. If left out, the textField style from the current GUISkin is used.
        * @returns The edited password.
        * @methodSwap PasswordField_EBB7509C_A250E3CF
        */
        public static PasswordField ($password: string, $maskChar: number, $maxLength: int, $style: GUIStyle, ...options: GUILayoutOption[]) : string
        /**
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.&amp;lt;br&amp;gt;
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The edited string.
        * @methodSwap TextArea_EBB7509C_H1811042B
        */
        public static TextArea ($text: string, $maxLength: int, ...options: GUILayoutOption[]) : string
        /**
        * Make a multi-line text field where the user can edit a string.
        * @param text Text to edit. The return value of this function should be assigned back to the string as shown in the example.
        * @param maxLength The maximum length of the string. If left out, the user can type for ever and ever.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.&amp;lt;br&amp;gt;
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The edited string.
        * @methodSwap TextArea_EBB7509C_H5B1335D4
        */
        public static TextArea ($text: string, $maxLength: int, $style: GUIStyle, ...options: GUILayoutOption[]) : string
        /**
        * Make an on/off toggle button.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_D1F56785
        */
        public static Toolbar ($selected: int, $texts: string[], ...options: GUILayoutOption[]) : int
        /**
        * Make a toolbar.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_B74C49FF
        */
        public static Toolbar ($selected: int, $images: Texture[], ...options: GUILayoutOption[]) : int
        /**
        * Make a toolbar.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_H747DA816
        */
        public static Toolbar ($selected: int, $contents: GUIContent[], ...options: GUILayoutOption[]) : int
        /**
        * Make a toolbar.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_H47B5F86A
        */
        public static Toolbar ($selected: int, $texts: string[], $style: GUIStyle, ...options: GUILayoutOption[]) : int
        /**
        * Make a toolbar.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_F1C1F8E0
        */
        public static Toolbar ($selected: int, $images: Texture[], $style: GUIStyle, ...options: GUILayoutOption[]) : int
        /**
        * Make a toolbar.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_H88C7123
        */
        public static Toolbar ($selected: int, $texts: string[], $style: GUIStyle, $buttonSize: UnityEngine_GUI.ToolbarButtonSize, ...options: GUILayoutOption[]) : int
        /**
        * Make a toolbar.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_H3BCBEF4D
        */
        public static Toolbar ($selected: int, $images: Texture[], $style: GUIStyle, $buttonSize: UnityEngine_GUI.ToolbarButtonSize, ...options: GUILayoutOption[]) : int
        /**
        * Make a toolbar.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_F54EFF05
        */
        public static Toolbar ($selected: int, $contents: GUIContent[], $style: GUIStyle, ...options: GUILayoutOption[]) : int
        /**
        * Make a toolbar.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param buttonSize Determines how toolbar button size is calculated.
        * @returns The index of the selected button.
        * @methodSwap Toolbar_EBB7509C_H199BAF5E
        */
        public static Toolbar ($selected: int, $contents: GUIContent[], $style: GUIStyle, $buttonSize: UnityEngine_GUI.ToolbarButtonSize, ...options: GUILayoutOption[]) : int
        /**
        * @methodSwap Toolbar_EBB7509C_H549A9AE2
        */
        public static Toolbar ($selected: int, $contents: GUIContent[], $enabled: boolean[], $style: GUIStyle, ...options: GUILayoutOption[]) : int
        /**
        * @methodSwap Toolbar_EBB7509C_C07DEFDB
        */
        public static Toolbar ($selected: int, $contents: GUIContent[], $enabled: boolean[], $style: GUIStyle, $buttonSize: UnityEngine_GUI.ToolbarButtonSize, ...options: GUILayoutOption[]) : int
        /**
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H30201FA6
        */
        public static SelectionGrid ($selected: int, $texts: string[], $xCount: int, ...options: GUILayoutOption[]) : int
        /**
        * Make a Selection Grid.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H496D0D88
        */
        public static SelectionGrid ($selected: int, $images: Texture[], $xCount: int, ...options: GUILayoutOption[]) : int
        /**
        * Make a Selection Grid.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H8150C701
        */
        public static SelectionGrid ($selected: int, $content: GUIContent[], $xCount: int, ...options: GUILayoutOption[]) : int
        /**
        * Make a Selection Grid.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_H296F1B75
        */
        public static SelectionGrid ($selected: int, $texts: string[], $xCount: int, $style: GUIStyle, ...options: GUILayoutOption[]) : int
        /**
        * Make a Selection Grid.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_A9D5AB
        */
        public static SelectionGrid ($selected: int, $images: Texture[], $xCount: int, $style: GUIStyle, ...options: GUILayoutOption[]) : int
        /**
        * Make a Selection Grid.
        * @param selected The index of the selected button.
        * @param texts An array of strings to show on the buttons.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The index of the selected button.
        * @methodSwap SelectionGrid_EBB7509C_B9F6272E
        */
        public static SelectionGrid ($selected: int, $contents: GUIContent[], $xCount: int, $style: GUIStyle, ...options: GUILayoutOption[]) : int
        /**
        * A horizontal slider the user can drag to change a value between a min and a max.
        * @param value The value the slider shows. This determines the position of the draggable thumb.
        * @param leftValue The value at the left end of the slider.
        ...
        * @returns The value that has been set by the user.
        * @methodSwap HorizontalSlider_EBB7509C_B9E5EAC3
        */
        public static HorizontalSlider ($value: float, $leftValue: float, $rightValue: float, ...options: GUILayoutOption[]) : float
        /**
        * A horizontal slider the user can drag to change a value between a min and a max.
        * @param value The value the slider shows. This determines the position of the draggable thumb.
        * @param leftValue The value at the left end of the slider.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.
        * @returns The value that has been set by the user.
        * @methodSwap HorizontalSlider_EBB7509C_D71E16B7
        */
        public static HorizontalSlider ($value: float, $leftValue: float, $rightValue: float, $slider: GUIStyle, $thumb: GUIStyle, ...options: GUILayoutOption[]) : float
        /**
        * A vertical slider the user can drag to change a value between a min and a max.
        * @param value The value the slider shows. This determines the position of the draggable thumb.
        * @param topValue The value at the top end of the slider.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.
        * @returns The value that has been set by the user.
        * @methodSwap VerticalSlider_EBB7509C_B9E5EAC3
        */
        public static VerticalSlider ($value: float, $leftValue: float, $rightValue: float, ...options: GUILayoutOption[]) : float
        /**
        * A vertical slider the user can drag to change a value between a min and a max.
        * @param value The value the slider shows. This determines the position of the draggable thumb.
        * @param topValue The value at the top end of the slider.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.
        * @returns The value that has been set by the user.
        * @methodSwap VerticalSlider_EBB7509C_D71E16B7
        */
        public static VerticalSlider ($value: float, $leftValue: float, $rightValue: float, $slider: GUIStyle, $thumb: GUIStyle, ...options: GUILayoutOption[]) : float
        /**
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.
        * @returns The modified value. This can be changed by the user by dragging the scrollbar, or clicking the arrows at the end.
        * @methodSwap HorizontalScrollbar_EBB7509C_CB87338A
        */
        public static HorizontalScrollbar ($value: float, $size: float, $leftValue: float, $rightValue: float, ...options: GUILayoutOption[]) : float
        /**
        * Make a horizontal scrollbar.
        * @param value The position between min and max.
        * @param size How much can we see?
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.
        * @returns The modified value. This can be changed by the user by dragging the scrollbar, or clicking the arrows at the end.
        * @methodSwap HorizontalScrollbar_EBB7509C_H7CDB2731
        */
        public static HorizontalScrollbar ($value: float, $size: float, $leftValue: float, $rightValue: float, $style: GUIStyle, ...options: GUILayoutOption[]) : float
        /**
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.
        * @returns The modified value. This can be changed by the user by dragging the scrollbar, or clicking the arrows at the end.
        * @methodSwap VerticalScrollbar_EBB7509C_CB87338A
        */
        public static VerticalScrollbar ($value: float, $size: float, $topValue: float, $bottomValue: float, ...options: GUILayoutOption[]) : float
        /**
        * Make a vertical scrollbar.
        * @param value The position between min and max.
        * @param size How much can we see?
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.
        * @returns The modified value. This can be changed by the user by dragging the scrollbar, or clicking the arrows at the end.
        * @methodSwap VerticalScrollbar_EBB7509C_H7CDB2731
        */
        public static VerticalScrollbar ($value: float, $size: float, $topValue: float, $bottomValue: float, $style: GUIStyle, ...options: GUILayoutOption[]) : float
        /**
        * Insert a space in the current layout group.
        */
        public static Space ($pixels: float) : void
        /**
        ...
        * @methodSwap Window_EBB7509C_H365CFE73
        */
        public static Window ($id: int, $screenRect: Rect, $func: UnityEngine_GUI.WindowFunction, $text: string, ...options: GUILayoutOption[]) : Rect
        /**
        * Make a popup window that layouts its contents automatically.
        * @param id A unique ID to use for each window. This is the ID you'll use to interface to it.
        * @param screenRect Rectangle on the screen to use for the window. The layouting system will attempt to fit the window inside it - if that cannot be done, it will adjust the rectangle to fit.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style or the screenRect you pass in.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rectangle the window is at. This can be in a different position and have a different size than the one you passed in.
        * @methodSwap Window_EBB7509C_AB0B745
        */
        public static Window ($id: int, $screenRect: Rect, $func: UnityEngine_GUI.WindowFunction, $image: Texture, ...options: GUILayoutOption[]) : Rect
        /**
        * Make a popup window that layouts its contents automatically.
        * @param id A unique ID to use for each window. This is the ID you'll use to interface to it.
        * @param screenRect Rectangle on the screen to use for the window. The layouting system will attempt to fit the window inside it - if that cannot be done, it will adjust the rectangle to fit.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style or the screenRect you pass in.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rectangle the window is at. This can be in a different position and have a different size than the one you passed in.
        * @methodSwap Window_EBB7509C_EAF7ACE4
        */
        public static Window ($id: int, $screenRect: Rect, $func: UnityEngine_GUI.WindowFunction, $content: GUIContent, ...options: GUILayoutOption[]) : Rect
        /**
        * Make a popup window that layouts its contents automatically.
        * @param id A unique ID to use for each window. This is the ID you'll use to interface to it.
        * @param screenRect Rectangle on the screen to use for the window. The layouting system will attempt to fit the window inside it - if that cannot be done, it will adjust the rectangle to fit.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style or the screenRect you pass in.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rectangle the window is at. This can be in a different position and have a different size than the one you passed in.
        * @methodSwap Window_EBB7509C_A618D6AC
        */
        public static Window ($id: int, $screenRect: Rect, $func: UnityEngine_GUI.WindowFunction, $text: string, $style: GUIStyle, ...options: GUILayoutOption[]) : Rect
        /**
        * Make a popup window that layouts its contents automatically.
        * @param id A unique ID to use for each window. This is the ID you'll use to interface to it.
        * @param screenRect Rectangle on the screen to use for the window. The layouting system will attempt to fit the window inside it - if that cannot be done, it will adjust the rectangle to fit.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style or the screenRect you pass in.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rectangle the window is at. This can be in a different position and have a different size than the one you passed in.
        * @methodSwap Window_EBB7509C_H25EB8BAA
        */
        public static Window ($id: int, $screenRect: Rect, $func: UnityEngine_GUI.WindowFunction, $image: Texture, $style: GUIStyle, ...options: GUILayoutOption[]) : Rect
        /**
        * Make a popup window that layouts its contents automatically.
        * @param id A unique ID to use for each window. This is the ID you'll use to interface to it.
        * @param screenRect Rectangle on the screen to use for the window. The layouting system will attempt to fit the window inside it - if that cannot be done, it will adjust the rectangle to fit.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style or the screenRect you pass in.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rectangle the window is at. This can be in a different position and have a different size than the one you passed in.
        * @methodSwap Window_EBB7509C_D2D4CD2F
        */
        public static Window ($id: int, $screenRect: Rect, $func: UnityEngine_GUI.WindowFunction, $content: GUIContent, $style: GUIStyle, ...options: GUILayoutOption[]) : Rect
        /**
        * Option passed to a control to give it an absolute width.
        */
        public static Width ($width: float) : GUILayoutOption
        /**
        * Option passed to a control to specify a minimum width.
        */
        public static MinWidth ($minWidth: float) : GUILayoutOption
        /**
        * Option passed to a control to specify a maximum width.
        */
        public static MaxWidth ($maxWidth: float) : GUILayoutOption
        /**
        * Option passed to a control to give it an absolute height.
        */
        public static Height ($height: float) : GUILayoutOption
        /**
        * Option passed to a control to specify a minimum height.
        */
        public static MinHeight ($minHeight: float) : GUILayoutOption
        /**
        * Option passed to a control to specify a maximum height.
        */
        public static MaxHeight ($maxHeight: float) : GUILayoutOption
        /**
    ...
    */
    class GUILayoutUtility extends System.Object {
        ...
        * @methodSwap GetRect_EBB7509C_H1075CF37
        */
        public static GetRect ($width: float, $height: float) : Rect
        /**
        * Reserve layout space for a rectangle with a fixed content area.
        * @param width The width of the area you want.
        * @param height The height of the area you want.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rectangle to put your control in.
        * @methodSwap GetRect_EBB7509C_EED70728
        */
        public static GetRect ($width: float, $height: float, $style: GUIStyle) : Rect
        /**
        * Reserve layout space for a rectangle with a fixed content area.
        * @param width The width of the area you want.
        * @param height The height of the area you want.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rectangle to put your control in.
        * @methodSwap GetRect_EBB7509C_H3493C150
        */
        public static GetRect ($width: float, $height: float, ...options: GUILayoutOption[]) : Rect
        /**
        * Reserve layout space for a rectangle with a fixed content area.
        * @param width The width of the area you want.
        * @param height The height of the area you want.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rectangle to put your control in.
        * @methodSwap GetRect_EBB7509C_B748423
        */
        public static GetRect ($width: float, $height: float, $style: GUIStyle, ...options: GUILayoutOption[]) : Rect
        /**
        ...
        * @methodSwap GetRect_EBB7509C_H3F97763D
        */
        public static GetRect ($minWidth: float, $maxWidth: float, $minHeight: float, $maxHeight: float) : Rect
        /**
        * Reserve layout space for a flexible rect.
        * @param minWidth The minimum width of the area passed back.
        * @param maxWidth The maximum width of the area passed back.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns A rectangle with size between minWidth & maxWidth on both axes.
        * @methodSwap GetRect_EBB7509C_FB715F2
        */
        public static GetRect ($minWidth: float, $maxWidth: float, $minHeight: float, $maxHeight: float, $style: GUIStyle) : Rect
        /**
        * Reserve layout space for a flexible rect.
        * @param minWidth The minimum width of the area passed back.
        * @param maxWidth The maximum width of the area passed back.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns A rectangle with size between minWidth & maxWidth on both axes.
        * @methodSwap GetRect_EBB7509C_CB87338A
        */
        public static GetRect ($minWidth: float, $maxWidth: float, $minHeight: float, $maxHeight: float, ...options: GUILayoutOption[]) : Rect
        /**
        * Reserve layout space for a flexible rect.
        * @param minWidth The minimum width of the area passed back.
        * @param maxWidth The maximum width of the area passed back.
        ...
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns A rectangle with size between minWidth & maxWidth on both axes.
        * @methodSwap GetRect_EBB7509C_H7CDB2731
        */
        public static GetRect ($minWidth: float, $maxWidth: float, $minHeight: float, $maxHeight: float, $style: GUIStyle, ...options: GUILayoutOption[]) : Rect
        /**
        ...
        * @methodSwap GetAspectRect_EBB7509C_H82424F3E
        */
        public static GetAspectRect ($aspect: float) : Rect
        /**
        * Reserve layout space for a rectangle with a specific aspect ratio.
        * @param aspect The aspect ratio of the element (width / height).
        * @param style An optional style. If specified, the style's padding value will be added to the sizes of the returned rectangle & the style's margin values will be used for spacing.
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rect for the control.
        * @methodSwap GetAspectRect_EBB7509C_H8E84C075
        */
        public static GetAspectRect ($aspect: float, $style: GUIStyle) : Rect
        /**
        * Reserve layout space for a rectangle with a specific aspect ratio.
        * @param aspect The aspect ratio of the element (width / height).
        * @param style An optional style. If specified, the style's padding value will be added to the sizes of the returned rectangle & the style's margin values will be used for spacing.
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rect for the control.
        * @methodSwap GetAspectRect_EBB7509C_AC065FD
        */
        public static GetAspectRect ($aspect: float, ...options: GUILayoutOption[]) : Rect
        /**
        * Reserve layout space for a rectangle with a specific aspect ratio.
        * @param aspect The aspect ratio of the element (width / height).
        * @param style An optional style. If specified, the style's padding value will be added to the sizes of the returned rectangle & the style's margin values will be used for spacing.
        * @param options An optional list of layout options that specify extra layouting properties. Any values passed in here will override settings defined by the style.<br>
        ...
        GUILayout.MaxHeight, GUILayout.ExpandWidth, GUILayout.ExpandHeight.
        * @returns The rect for the control.
        * @methodSwap GetAspectRect_EBB7509C_H383C91F2
        */
        public static GetAspectRect ($aspect: float, $style: GUIStyle, ...options: GUILayoutOption[]) : Rect
    }
    ...
    */
    class GUIUtility extends System.Object {
        ...
        */
        public static get hotControl(): int;
        public static set hotControl(value: int);
        /**
        * The controlID of the control that has keyboard focus.
        */
        public static get keyboardControl(): int;
        public static set keyboardControl(value: int);

        public constructor ()
        /**
        * Get a unique ID for a control, using an integer as a hint to help ensure correct matching of IDs to controls.
        * @methodSwap GetControlID_EBB7509C_H1BBC1CA2
        */
        public static GetControlID ($hint: int, $focusType: FocusType, $rect: Rect) : int
        /**
        ...
        */
        public static AlignRectToDevice ($rect: Rect, $widthInPixels: $Ref<int>, $heightInPixels: $Ref<int>) : Rect
        /**
        * Get a unique ID for a control.
        */
        public static GetControlID ($focus: FocusType) : int
        /**
        * Get a unique ID for a control, using a the label content as a hint to help ensure correct matching of IDs to controls.
        */
        public static GetControlID ($contents: GUIContent, $focus: FocusType) : int
        /**
        * Get a unique ID for a control.
        */
        public static GetControlID ($focus: FocusType, $position: Rect) : int
        /**
        * Get a unique ID for a control, using a the label content as a hint to help ensure correct matching of IDs to controls.
        */
        public static GetControlID ($contents: GUIContent, $focus: FocusType, $position: Rect) : int
        /**
        * Get a unique ID for a control, using an integer as a hint to help ensure correct matching of IDs to controls.
        * @methodSwap GetControlID_EBB7509C_H14B30567
        */
        public static GetControlID ($hint: int, $focus: FocusType) : int
        /**
        * Get a state object from a controlID.
        */
        public static GetStateObject ($t: System.Type, $controlID: int) : any
        /**
        * Get an existing state object from a controlID.
        */
        public static QueryStateObject ($t: System.Type, $controlID: int) : any
        /**
        ...
        */
        public static RotateAroundPivot ($angle: float, $pivotPoint: Vector2) : void
        /**
    ...
    */
    ...
    class TextEditor extends System.Object {
        ...
        public get cursorIndex(): int;
        public set cursorIndex(value: int);
        public get selectIndex(): int;
        public set selectIndex(value: int);
        ...
        public get altCursorPosition(): int;
        public set altCursorPosition(value: int);
        ...
        public FindStartOfNextWord ($p: int) : int
...
declare module 'UnityEngine.GUI' {
    ...
    */
    ...
    var WindowFunction: { new (func: (id: int) => void): WindowFunction; }
    ...
    */
    class ScrollViewScope extends Scope {
...
declare module 'UnityEngine.GUILayout' {
    ...
    */
    class HorizontalScope extends UnityEngine_GUI.Scope {
    ...
    */
    class VerticalScope extends UnityEngine_GUI.Scope {
    ...
    */
    class AreaScope extends UnityEngine_GUI.Scope {
    ...
    * Disposable helper class for managing BeginScrollView / EndScrollView.
    */
    class ScrollViewScope extends UnityEngine_GUI.Scope {
